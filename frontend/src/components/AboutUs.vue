<template>
  <div class="about-us">
    ...
    <main>
      ...
      <!-- Dropdown Menu -->
      <!-- <div class="dropdown">
        <button @click="toggleDropdown">Learn More</button>
...
export default {
  ...
  data() {
    return {
      isDropdownOpen: false, // For toggling the dropdown menu
    };
  },
  methods: {
    toggleDropdown() {
...
<style scoped>
  ...
  .hero {
    background-image: url('/src/img/heroBg.jpg'); /* Replace with the path to your background image */
